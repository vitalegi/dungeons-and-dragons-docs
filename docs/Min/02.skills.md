...
| :material-check-circle:{: .highlight } [Anello Cinetico](#anello-cinetico) | close, <br>`# CHARGE` | `# CHARGE d4` | Aumenta danno di un colpo senz'armi. |
...
This ring stores the kinetic energy from the wielders arm during everyday motion (walking, running, swinging, etc), __gaining 1 charge every day__ it is worn and attuned.
